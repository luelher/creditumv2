...
abstract class BasesfGuardRememberKeyPeer {
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfGuardRememberKeyPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasesfGuardRememberKeyPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfGuardRememberKeyPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasesfGuardRememberKeyPeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfGuardRememberKeyPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BasesfGuardRememberKeyPeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BasesfGuardRememberKeyPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BasesfGuardRememberKeyPeer', $values, $con, $ret);
    }

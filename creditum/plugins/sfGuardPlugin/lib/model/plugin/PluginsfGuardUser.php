...
class PluginsfGuardUser extends BasesfGuardUser
{
  ...
  public function getPermissions()
  {
    if (!$this->permissions)
    {
      ...
      if($this->usuario){
        switch ($this->usuario->getIdNivel()){
          case 1: // OPERADOR ADMINISTRADOR
            $this->permissions['OA'] = 'OA';
            break;
          case 2: // OPERADOR
            $this->permissions['O'] = 'O';
            break;
          case 3: // CONSULTOR
            $this->permissions['C'] = 'C';
            break;
          case 4: // CONSULTOR ADMINISTRADOR
            $this->permissions['CA'] = 'CA';
            break;
        }

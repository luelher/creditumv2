...
abstract class BaseClientes extends BaseObject  implements Persistent {
  ...
  const PEER = 'ClientesPeer';
	...
	public function setIdCasaComercial($v)
	{
		...
		if ($this->id_casa_comercial !== $v || $v === 0) {
			$this->id_casa_comercial = $v;
			$this->modifiedColumns[] = ClientesPeer::ID_CASA_COMERCIAL;
		}
	...
	public function setCelular($v)
	{
		...
		if ($this->celular !== $v) {
			$this->celular = $v;
			$this->modifiedColumns[] = ClientesPeer::CELULAR;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(ClientesPeer::ID_CASA_COMERCIAL,ClientesPeer::NOMBRE))) {
				return false;
			}

			if ($this->id_casa_comercial !== 0) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_casa_comercial = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			...
			$this->celular = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			...
			return $startcol + 10; // 10 = ClientesPeer::NUM_COLUMNS - ClientesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[1] => $this->getIdCasaComercial(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setIdCasaComercial($arr[$keys[1]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ClientesPeer::ID_CASA_COMERCIAL)) $criteria->add(ClientesPeer::ID_CASA_COMERCIAL, $this->id_casa_comercial);
		...
		if ($this->isColumnModified(ClientesPeer::CELULAR)) $criteria->add(ClientesPeer::CELULAR, $this->celular);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setIdCasaComercial($this->id_casa_comercial);

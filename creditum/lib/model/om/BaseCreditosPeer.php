...
abstract class BaseCreditosPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new CreditosMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseCreditosPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseCreditosPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseCreditosPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseCreditosPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return CreditosPeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseCreditosPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseCreditosPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseCreditosPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseCreditosPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseCreditosPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseCreditosPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseCreditosPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseCreditosPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Creditos) {
	...
	public static function doValidate(Creditos $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(CreditosPeer::DATABASE_NAME, CreditosPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = CreditosPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the CreditosPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the CreditosPeer class:
//
// Propel::getDatabaseMap(CreditosPeer::DATABASE_NAME)->addTableBuilder(CreditosPeer::TABLE_NAME, CreditosPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseCreditosPeer::DATABASE_NAME)->addTableBuilder(BaseCreditosPeer::TABLE_NAME, BaseCreditosPeer::getMapBuilder());

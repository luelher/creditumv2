...
abstract class BaseUsuarios extends BaseObject  implements Persistent {
  ...
  const PEER = 'UsuariosPeer';
	...
	public function setCedula($v)
	{
		...
		if ($this->cedula !== $v || $v === 0) {
			$this->cedula = $v;
			$this->modifiedColumns[] = UsuariosPeer::CEDULA;
		}
	...
	public function setIdCliente($v)
	{
		...
		if ($this->id_cliente !== $v || $v === 0) {
			$this->id_cliente = $v;
			$this->modifiedColumns[] = UsuariosPeer::ID_CLIENTE;
		}
	...
	public function setPwd($v)
	{
		...
		if ($this->pwd !== $v || $v === '') {
			$this->pwd = $v;
			$this->modifiedColumns[] = UsuariosPeer::PWD;
		}
	...
	public function setApellido($v)
	{
		...
		if ($this->apellido !== $v || $v === '') {
			$this->apellido = $v;
			$this->modifiedColumns[] = UsuariosPeer::APELLIDO;
		}
	...
	public function setCelular($v)
	{
		...
		if ($this->celular !== $v) {
			$this->celular = $v;
			$this->modifiedColumns[] = UsuariosPeer::CELULAR;
		}
	...
	public function setNacionalidad($v)
	{
		...
		if ($this->nacionalidad !== $v || $v === 'VENEZOLANO') {
			$this->nacionalidad = $v;
			$this->modifiedColumns[] = UsuariosPeer::NACIONALIDAD;
		}
	...
	public function setIdNivel($v)
	{
		...
		if ($this->id_nivel !== $v || $v === 0) {
			$this->id_nivel = $v;
			$this->modifiedColumns[] = UsuariosPeer::ID_NIVEL;
		}
	...
	public function setFecha($v)
	{
		...
		if ( $this->fecha !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = UsuariosPeer::FECHA;
			}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(UsuariosPeer::CEDULA,UsuariosPeer::ID_CLIENTE,UsuariosPeer::PWD,UsuariosPeer::NOMBRE,UsuariosPeer::APELLIDO,UsuariosPeer::NACIONALIDAD,UsuariosPeer::ID_NIVEL))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->cedula = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			$this->nacionalidad = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
			$this->id_nivel = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
			...
			return $startcol + 11; // 11 = UsuariosPeer::NUM_COLUMNS - UsuariosPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    foreach (sfMixer::getCallables('BaseUsuarios:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseUsuarios:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseUsuarios:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseUsuarios:save:post') as $callable)
    {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[7] => $this->getNacionalidad(),
			$keys[8] => $this->getIdNivel(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[7], $arr)) $this->setNacionalidad($arr[$keys[7]]);
		if (array_key_exists($keys[8], $arr)) $this->setIdNivel($arr[$keys[8]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UsuariosPeer::CEDULA)) $criteria->add(UsuariosPeer::CEDULA, $this->cedula);
		if ($this->isColumnModified(UsuariosPeer::ID_CLIENTE)) $criteria->add(UsuariosPeer::ID_CLIENTE, $this->id_cliente);
		if ($this->isColumnModified(UsuariosPeer::PWD)) $criteria->add(UsuariosPeer::PWD, $this->pwd);
		if ($this->isColumnModified(UsuariosPeer::NOMBRE)) $criteria->add(UsuariosPeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(UsuariosPeer::APELLIDO)) $criteria->add(UsuariosPeer::APELLIDO, $this->apellido);
		if ($this->isColumnModified(UsuariosPeer::TELEFONO)) $criteria->add(UsuariosPeer::TELEFONO, $this->telefono);
		if ($this->isColumnModified(UsuariosPeer::CELULAR)) $criteria->add(UsuariosPeer::CELULAR, $this->celular);
		if ($this->isColumnModified(UsuariosPeer::NACIONALIDAD)) $criteria->add(UsuariosPeer::NACIONALIDAD, $this->nacionalidad);
		if ($this->isColumnModified(UsuariosPeer::ID_NIVEL)) $criteria->add(UsuariosPeer::ID_NIVEL, $this->id_nivel);
		if ($this->isColumnModified(UsuariosPeer::FECHA)) $criteria->add(UsuariosPeer::FECHA, $this->fecha);
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseUsuarios:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseUsuarios::%s', $method));
    }
